...
import com.mobitech.naiweather.R;
 ...
 */
public final class NaiWeatherUtils {

    private static final String LOG_TAG = NaiWeatherUtils.class.getSimpleName();
    ...
    public static String formatTemperature(Context context, double temperature) {
        ...
        if (!NaiWeatherPreferences.isMetric(context)) {
